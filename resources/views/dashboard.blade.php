        ...
        <div class="mx-auto mt-10 mb-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-5 pt-10 sm:mt-5 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          @foreach ($data['data'] as $year)
            <article
              ...
              <a href="inventory/{{$year['year']}}">
                <h3 class="mt-0.5 text-lg font-medium text-gray-900">
                  Inventaris tahun {{$year['year']}}
                </h3>
              </a>
              <a href="inventory/{{$year['year']}}" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
                Details
