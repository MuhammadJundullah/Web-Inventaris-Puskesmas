        ...
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500">Are you sure you want to deleted your account? All of your data will be permanently removed. This action cannot be undone.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <table class="min-w-full border-collapse">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="py-2">*****</td>
                            <td id="openModal" class="py-2"><a href="#" class="text-red-500 hover:underline">Hapus akun</a></td>
                        </tr>
