                                    ...
                                    <table>
                                        ...
                                        <tbody id="tableBody">
                                            ...
                                            <tr class="border-b hover:bg-gray-100">
                                                ...
                                                <td class="py-2 text-center">{{$post['nama']}}</td>
                                                <td class="py-2 text-center">{{$post['sumber']}}</td>
                                                ...
                                                <td class="py-2">
                                                    <div class="inline-flex rounded-lg p-1 justify-end items-end sm:ml-20">
                                                        <a href="/audit/edit/{{$data['tahun']}}/{{$post['id']}}">
                                                        ...
                                                        <a href="/inventory/{{$data['tahun']}}/{{$post['id']}}">
                                                        ...
                                                        <button
                                                            onclick="openDeleteModal('{{ $data['tahun']}}', {{$post['id']}})"
