        ...
        <form class="mb-10" action="/bendahara/audit/tambah" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Tambah Arsip Bendahara</h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <label for="nama_pegawai" class="block text-sm font-medium leading-6 text-gray-900">Nama Pegawai :</label>
                            <div class="mt-2">
                                ...
                                <input type="text" name="nama_pegawai" id="nama_pegawai" autocomplete="nama_pegawai" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder=" Masukkan Nama Pegawai" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 sm:max-w-md">
                                    <input type="text" name="kegiatan" id="kegiatan" autocomplete="kegiatan" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder=" Masukkan Kegiatan" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-4">
                            <label for="dana_yang_digunakan" class="block text-sm font-medium leading-6 text-gray-900">Dana yang digunakan :</label>
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 sm:max-w-md">
                                    <input type="text" name="dana_yang_digunakan" id="dana_yang_digunakan" autocomplete="dana_yang_digunakan" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder=" Masukkan Kegiatan" required>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- input tanggal masuk--}}
                        <div class="sm:col-span-4">
                            <label for="tanggal" class="block text-sm font-medium leading-6 text-gray-900">Tanggal Kegiatan :</label>
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 sm:max-w-md">
